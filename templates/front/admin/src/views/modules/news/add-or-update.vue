		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.introduction" label="简介" prop="introduction">
					<span :style='{"padding":"0 20px","color":"inherit","background":"#edf7ff","display":"inline-block","width":"80%","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}'>{{ruleForm.introduction}}</span>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../djangoh5vhw6z3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
