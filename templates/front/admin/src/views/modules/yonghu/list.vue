		...
		<template v-if="showFlag">
			...
			<div class="one" :style='{"margin":"0px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"16px","justifyContent":"flex-start","height":"auto"}'>
			  <div v-for="(item,index) in dataList" :style='{"border":"0px solid #e6e6e6","boxShadow":"0 0px 6px rgba(0,0,0,.1)","margin":"0 2% 30px 0","background":"#fff","width":"23%","position":"relative","height":"auto"}' :key="index">
			    <div :style='{"padding":"5px 10px","lineHeight":"32px","fontSize":"inherit","color":"#666","textAlign":"center","background":"#fff"}' class="name">{{item.yonghuxingming}}</div>
			    ...
			    <div :style='{"padding":"10px 10px 10px","margin":"10px 0","alignItems":"flex-end","flexWrap":"wrap","display":"flex","width":"100%","fontSize":"14px","justifyContent":"flex-start","height":"auto"}'>
			      <el-button class="list1-view" v-if=" isAuth('yonghu','查看')" @click="addOrUpdateHandler(item.id,'info')">
			        <span class="icon iconfont icon-chakan2" :style='{"color":"inherit","margin":"0 2px","fontSize":"inherit"}'></span>
			        查看
			      </el-button>
			      <el-button class="list1-edit" v-if=" isAuth('yonghu','修改') " @click="addOrUpdateHandler(item.id)">
			        <span class="icon iconfont icon-xiugai1" :style='{"color":"inherit","margin":"0 2px","fontSize":"inherit"}'></span>
			        修改
			      </el-button>
			      <el-button class="list1-del" v-if="isAuth('yonghu','删除') " @click="deleteHandler(item.id)">
