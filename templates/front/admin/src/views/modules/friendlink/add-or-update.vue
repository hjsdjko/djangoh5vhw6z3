		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.url" label="链接" prop="url">
					<span :style='{"padding":"0 20px","color":"inherit","background":"#edf7ff","display":"inline-block","width":"80%","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}'>{{ruleForm.url}}</span>
				</el-form-item>
