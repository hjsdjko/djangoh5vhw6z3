<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 64px","margin":"0","position":"relative","background":"#f3f3f3","display":"block"} : {"minHeight":"100%","padding":"0 0 0 210px","margin":"0","position":"relative","background":"#edf7ff","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0px 150px 0px 30px","margin":"0 auto","borderColor":"rgba(126, 96, 16, .2)","alignItems":"center","color":"#333","display":"flex","justifyContent":"space-between","top":"0","left":"0","background":"#fff","borderWidth":"0 0 0px","width":"calc(100% - 0px)","fontSize":"14px","position":"relative","borderStyle":"solid","zIndex":"1002","height":"68px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"16px 30px","margin":"0px auto 0","borderColor":"#eee","borderWidth":"0 0 0px 0","width":"auto","fontSize":"14px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
